...
public class ListadoInvestigador extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Investigador inv = new Investigador((String)jTable1.getValueAt(jTable1.getSelectedRow(), 2)); //crea un investigador con el campo del dni como param
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Object[] options = {"Si, borrarlo",
                    "Cancelar"};
        int n = JOptionPane.showOptionDialog(this, "Realmente desea borrar este usuario? ", "Precaución", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[1]);
        if(n == 0){
            Investigador inv = new Investigador((String)jTable1.getValueAt(jTable1.getSelectedRow(), 2)); //crea un investigador con el campo del dni como param
    ...
    public void initTabla(){
        ...
        LinkedList listaInv = Investigador.getListaInvestigadores();
        dtm.addColumn("Nombre");
        dtm.addColumn("Apellido");
        dtm.addColumn("Dni");
        dtm.addColumn("Telefono");
        dtm.addColumn("Email");
        dtm.addColumn("Codido");
    ...
    private Object[] getFila(Investigador inv ){
        ...
        datos[5] = inv.getCodigo();      
        datos[6] = inv.getObservaciones();
        return datos;
    }
    ...
    public void actualizarFila(Investigador nuevo){
        ...
        //System.out.println(""+nuevo.getId() +" - "+ nuevo.getTelefono());
        this.dtm.setValueAt(nuevo.getEmail(), jTable1.getSelectedRow(), 4);
        this.dtm.setValueAt(nuevo.getCodigo(), jTable1.getSelectedRow(), 5);
        this.dtm.setValueAt(nuevo.getObservaciones(), jTable1.getSelectedRow(), 6);
    }
