...
public class ModificarUsuario extends javax.swing.JFrame {
    ...
    public ModificarUsuario(Investigador inv, ListadoInvestigador padre) {
        ...
        esEncargado.setSelected(inv.getEsEncargado());        
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Investigador nuevo = new Investigador(0, nombre.getText(), apellido.getText(), Integer.parseInt(dni.getText()), telefono.getText(), telefono2.getText(), email.getText(), codigo.getText(),observacion.getText(), esEncargado.isSelected() );
        nuevo.modificarInvestigador(investigador.getId());
